...
namespace BertScout2026.Database
{
    public class MatchDatabase
    {
        ...
        private const string DatabaseFilename = "MatchScout2026.db3";
        ...
        public async Task<List<Match>> GetItemsAsync()
        {
            await Init();
        ...
        public async Task<List<Match>> GetChangedItemsAsync()
        {
            await Init();
            return await Database.Table<Match>()
                .Where(i => i.Changed)
        ...
        public async Task<Match> GetItemAsync(int id)
        {
            await Init();
            return await Database.Table<Match>()
                .Where(i => i.Id == id)
        ...
        public async Task<int> SaveItemAsync(Match item)
        {
            await Init();
            if (item.Id != 0)
            {
